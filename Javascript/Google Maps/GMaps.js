...
downloadUrl("/Javascript/Google Maps/Map Connect.php", function(data) {
  ...
  for (var i = 0; i < markers.length; i++) {
    ...
    console.log(name, title, type, imgsrc);
    ...
    var html = "<b>" + name + "</b> <br/> <b>" + title + "</b> <br/> <img src=" + imgsrc + " style='position: relative; max-width: 200px; max-height: 200px; -moz-transform:rotate(" + orient + "deg); -webkit-transform:rotate(" + orient + "deg); -o-transform:rotate(" + orient + "deg); -ms-transform:rotate(" + orient + "deg); top: 50px;'/>";
